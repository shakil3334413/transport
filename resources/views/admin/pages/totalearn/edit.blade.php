        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="element-wrapper">
                    ...
                    <form method="POST" action="{{route('allearn.update',$earn->id)}}">
                      @csrf
                      @method('PUT')
                          <div class="steps-w">
                            ...
                            <div class="step-contents">
                              <div class="step-content active" id="stepContent1">
                                <div class="form-group">
                                  ...
                                  <option value="{{$count->id}}" {{$count->id==$earn->counter_id?'selected':''}}>{{$count->name}}</option>
                                    @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <span style="color: red">আগের তারিখ:&nbsp;{{$earn->ticket->date}}</span>
                                    <input type="text" name="old_date" value="{{$earn->ticket->date}}" hidden>
                                  </div>
                                <div class="row">
                                  <div class="col-sm-6">
                                    <div class="form-group">
                                      <label for="total_ticket"> মোট টিকেট সংখ্যা </label>
                                    <input class="form-control" id="total_ticket" placeholder="মোট টিকেট সংখ্যা " type="number" min="1" name="total_ticket" value="{{$earn->ticket->total_ticket}}">
                                    </div>
                                  </div>
                                  <div class="col-sm-6">
                                    <div class="form-group">
                                      <label for="per_ticket_price">প্রতিটি টিকেট এর  মূল্য </label>
                                    <input class="form-control" id="per_ticket_price" placeholder="Exp:৩০ টাকা " type="number" name="per_ticket_price" value="{{$earn->ticket->per_ticket_price}}">
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-sm-6">
                                    ...
                                    <input class="form-control" placeholder=""  id="total_amount" type="text" name="total_amount"   value="{{$earn->ticket->total_amount}}"  readonly>
                                    </div>
                                  </div>
                                  <div class="col-sm-6">
                                    <div class="form-group">
                                      ...
                                      <select name="shift" id="" class="form-control">
                                        <option value="1" {{$earn->ticket->shift ==1 ? 'selected':''}}>সকাল </option>
                                        <option value="0" {{$earn->ticket->shift ==0 ? 'selected':''}}>বিকাল</option>
                                      </select>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div class="step-content" id="stepContent2">
                                ...
                                <input class="form-control" id="ass_total" placeholder="Exp:৩০ টাকা" type="number" name="ass_total" value="{{$earn->accessoriesearn->total_amount}}">
                                </div>
                                <div class="form-group">
                                  <label for="total_earn">সর্বমোট টাকা </label>
                                <input class="form-control" id="total_earn" placeholder="Exp:৩০ টাকা" type="number" name="total_earn" value="{{$earn->total_earn}}" readonly>
                                </div>
                                <div class="form-buttons-w text-right">
