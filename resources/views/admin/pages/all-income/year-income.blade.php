...
@section('title','Year Income List')
@section('content')
<div class="content-i">
    <div class="content-box">
        <div class="element-wrapper">
            <h6 class="element-header">
				বছরের মোট আয়ের তালিকা
            </h6>
            <div class="row">
				<div class="col-sm-6">
					<div class="element-box">
						<div class="table-responsive">
							<table id="dataTable1" id="dataTable1" width="100%" class="table text-center table-bordered table-striped table-lightfont">
