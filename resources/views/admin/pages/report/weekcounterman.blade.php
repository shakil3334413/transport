    ...
    <div class="container">
       <div class="row">
            <div class="col-md-12 text-center mt-5">
                ...
                <h6>পরিবহন <button onclick="myFunction()" class="btn btn-success btn-sm noprint float-right">Print</button><input type="button" class="btn btn-primary btn-sm noprint float-right mr-2"  id="btnExport" value="PDF" onclick="Export()" /></h6>
            </div>
            ...
            <div class="col-md-12 mt-2">
                <table id="tblCustomers" class="table table-bordered text-center">
                    ...
                    <tbody>
                    @foreach ($countermansalary as $key=>$countermansalarys)
                      <tr>
                        <td>{{ $key + 1 }}</td>
