    ...
    <div class="container">
       <div class="row">
            <div class="col-md-12 text-center mt-5">
                <h4>আজকের সাপ্তাহের এর বেতন এর লিস্ট </h4>
            ...
            <div class="col-md-12 mt-2">
                <table id="tblCustomers" class="table table-bordered text-center">
                    ...
                    <tbody>
                    @foreach ($helperalary as $key=>$helperalarys)
                      <tr>
                        <td scope="row">{{ $key + 1 }}</td>
                        <td>{{ Carbon\Carbon::parse($helperalarys->created_at)->format('d-M-Y') }}</td>
                        <td>{{$helperalarys->name}}</td>
                        <td>{{$helperalarys->counter_name}}</td>
                        <td>{{$helperalarys->shift}}</td>
                        <td>{{$helperalarys->taka}}&nbsp;টাকা</td>
                      </tr>
                    @endforeach
                    <tr>
                      <td></td>
