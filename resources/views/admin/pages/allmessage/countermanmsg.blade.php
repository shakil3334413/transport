...
@section('title','Counterman Message')
@section('content')
<div class="content-i">
    <div class="content-box">
        <div class="element-wrapper">
            <div class="element-box">
                <form action="{{route('countermanmsgsend')}}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="element-wrapper">
                            <h6 class="element-header">
                                কাউন্টারম্যানের কাছে  বার্তা বা মেসেজ পাঠান
                            <a class="btn btn-success float-right mr-2" href="{{route('countermaninfo')}}">মেসেজের তালিকা  দেখুন</a>
                            </h6>
                            <div class="element-box">
                                @csrf
