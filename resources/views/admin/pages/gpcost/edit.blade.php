            ...
            <div class="col-lg-12">
                <div class="element-wrapper">
                    <h6 class="element-header">
                        জিপি খরচ এর ইনফর্মেশন পরিবর্তন
                    ...
                    <div class="element-box">
                        <form action="{{route('gpcost.update',$gpcosts->id)}}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
						@csrf
						@method('put')
                            <h5 class="form-desc">
								জিপি খরচ এর ইনফর্মেশন পরিবর্তন  করুন
                            </h5>
