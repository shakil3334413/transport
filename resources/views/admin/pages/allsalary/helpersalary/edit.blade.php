...
@section('title','helper Salary Edit')
@section('content')
<div class="content-i">
            ...
            <div class="col-lg-12">
                <div class="element-wrapper">
                    <h6 class="element-header">
                        হেল্পারের বেতন বাবদ খরচ পরিবর্তন
                    ...
                    <div class="element-box">
                        <form action="{{route('helpersalary.update',$helpersalary->id)}}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
						@csrf
						@method('PUT')
                            <h5 class="form-desc">
								হেল্পারের বেতন বাবদ খরচ পরিবর্তন করুণ
                            </h5>
							...
							<div class="form-group row">
								...
								<div class="col-sm-5">
                                	<select name="shift" id="shift" class="form-control">
										<option value="সকাল" {{$helpersalary->shift == 'সকাল' ? 'selected' : ''}}>সকাল</option>
										<option value="বিকাল" {{$helpersalary->shift == 'বিকাল' ? 'selected' : ''}}>বিকাল</option>
									</select>
								</div>
							</div>
							<div class="form-group row">
