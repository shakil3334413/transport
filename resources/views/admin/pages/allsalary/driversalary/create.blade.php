...
@section('title','Driver Salary Create')
@section('content')
<div class="content-i">
            ...
            <div class="col-lg-12">
                <div class="element-wrapper">
                    <h6 class="element-header">
                        ড্রাইভারের বেতন বাবদ খরচ যোগ করুণ
                    ...
                    <div class="element-box">
                        <form action="{{route('driversalary.store')}}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                            <h5 class="form-desc">
