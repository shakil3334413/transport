            ...
            <div class="col-lg-12">
                <div class="element-wrapper">
                    ...
                    <div class="element-box">
                        ...
                        @csrf
                            <h5 class="form-desc">
								কাউন্টার খরচের ইনফর্মেশন পূরণ করুন 
                            </h5>
							...
							<div class="form-group row">
                                ...
                                <div class="col-sm-5">
									<input type="number" class="form-control{{ $errors->has('taka') ? ' is-invalid' : '' }}" name="taka" id="taka" placeholder="টাকার পরিমান লেখুন" required>
