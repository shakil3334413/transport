            ...
            <div class="col-lg-12">
                ...
                <div class="element-wrapper">
                    <h6 class="element-header">
						মালিকের গাড়ীর  ইনফর্মেশন পরিবর্তন
                        <a class="btn btn-success float-right mr-2" href="{{route('ownerbus.index')}}">মালিকের গাড়ীর তালিকা দেখুন</a>
                    </h6>
                    <div class="element-box">
                        <form action="{{route('ownerbus.update',$ownerbus->id)}}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
						@csrf
						@method('PUT')
                            <h5 class="form-desc">
								মালিকের গাড়ীর  ইনফর্মেশন পরিবর্তন করুন
                            </h5>
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-5">
                                	<select name="bus_id" id="bus_id" class="form-control {{ $errors->has('bus_id') ? ' is-invalid' : '' }}">
                                        ...
                                        <option value="{{$bus->id}}" {{$bus->number == $ownerbus->bus->number? 'selected' : '' }} >{{$bus->number}}</option>
										@endforeach
