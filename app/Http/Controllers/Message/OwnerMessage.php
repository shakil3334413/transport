...
class OwnerMessage extends Controller
{
    ...
    {
        $owner=Owner::all();
        return view('admin.pages.allmessage.ownermessage',compact('owner'));
    }

	public function info()
	{
		$ownermsg=OwnerMsg::latest()->get();
		return view('admin.pages.allmessage.ownermsginfo',compact('ownermsg'));
	}
    ...
    public function store(Request $request)
	{
		...
		Toastr::success('মালিকের কাছে মেসেজ সফলভাবে পাঠানো হয়েছে','Success',["positionClass" => "toast-bottom-right"]);
		return redirect()->route('ownerinfo');
	}
